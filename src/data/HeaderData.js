import main_logo from "@/assets/images/alinurlogo.png";
import logo_light from "@/assets/images/alinurlogo.png";
  ...
  icons: [
    {
      id: 1,
      icon: faMap,
      content: "Westside offices, Kruna road, Westlands, Nairobi, Kenya",
      subHref: "",
    },
    {
      id: 2,
      icon: faEnvelopeOpen,
      content: "support@alinurfoundation.org",
      subHref: "mailto",
    },
    {
      id: 3,
      icon: faMobile,
      content: "+254 707 710000",
      subHref: "tel",
    },
  ],
  navItems,
